...
function App() {
  ...
  const newsApi = async () => {
    try {
      ...
      const news = await axios.get(`${proxyUrl}https://newsapi.org/v2/top-headlines?country=in&pageSize=${loadMore}&category=${category}&apiKey=11ac1fa68b1f495aad113982a800ad89`)
